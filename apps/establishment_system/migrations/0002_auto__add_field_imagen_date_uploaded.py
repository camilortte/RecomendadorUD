...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Imagen.date_uploaded'
        db.add_column(u'establishment_system_imagen', 'date_uploaded',
                      self.gf('django.db.models.fields.DateField')(auto_now=True, default='2014-07-20', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Imagen.date_uploaded'
        db.delete_column(u'establishment_system_imagen', 'date_uploaded')
