...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'establishment_system_comentario', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['account_system.User'])),
            ('body', self.gf('django.db.models.fields.TextField')()),
            ('post', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['establishment_system.Establecimiento'])),
        ))
        db.send_create_signal(u'establishment_system', ['Comentario'])


    def backwards(self, orm):
        # Deleting model 'Comentario'
        db.delete_table(u'establishment_system_comentario')


    models = {
        u'account_system.tipo': {
            'Meta': {'object_name': 'Tipo'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '30'}),
            'tag': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '30'})
        },
        u'account_system.user': {
            ...
            'tipos': ('django.db.models.fields.related.ForeignKey', [], {'default': '3', 'to': u"orm['account_system.Tipo']"}),
        ...
        u'establishment_system.comentario': {
            'Meta': {'object_name': 'Comentario'},
            'author': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['account_system.User']"}),
            'body': ('django.db.models.fields.TextField', [], {}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'post': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['establishment_system.Establecimiento']"})
        },
