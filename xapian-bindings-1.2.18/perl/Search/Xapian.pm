...
*positionlist_count = *Search::Xapianc::TermIterator_positionlist_count;
...
*has_positions = *Search::Xapianc::Database_has_positions;
sub DISOWN {
    my $self = shift;
    my $ptr = tied(%$self);
    delete $OWNER{$ptr};
...
*STEM_ALL_Z = *Search::Xapianc::QueryParser_STEM_ALL_Z;
sub new {
  my $class = shift;
...
*STEM_NONE = *Search::Xapianc::TermGenerator_STEM_NONE;
*STEM_SOME = *Search::Xapianc::TermGenerator_STEM_SOME;
*STEM_ALL = *Search::Xapianc::TermGenerator_STEM_ALL;
*STEM_ALL_Z = *Search::Xapianc::TermGenerator_STEM_ALL_Z;
*set_flags = *Search::Xapianc::TermGenerator_set_flags;
*set_stemming_strategy = *Search::Xapianc::TermGenerator_set_stemming_strategy;
*set_max_word_length = *Search::Xapianc::TermGenerator_set_max_word_length;
